...
contract UpdateLMSRPricesFixTest is Test {
    ...
    function testAtomicStateUpdates() public pure {
        ...
        options[0] = PolicastLogic.OptionData({
            totalShares: 600 * 1e18,
            currentPrice: 0.6 * 1e18
        });
        options[1] = PolicastLogic.OptionData({
            totalShares: 400 * 1e18,
            currentPrice: 0.4 * 1e18
        });
    ...
    function testArrayLengthValidation() public {
        ...
        options[2] = PolicastLogic.OptionData({
            totalShares: 200 * 1e18,
            currentPrice: 0.2 * 1e18
        });
